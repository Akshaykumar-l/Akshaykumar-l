...
/* What is the percentage of unique product increase in 2021 vs. 2020? Thefinal output contains these fields,
...
WITH cte1 AS (
SELECT customer_code,product_code,sold_quantity,fiscal_year,extract(YEAR from date) AS Year,
...
SELECT Month,Year,ROUND(sum((sold_quantity*gross_price)),2) AS gross_sale_amount
FROM cte1
